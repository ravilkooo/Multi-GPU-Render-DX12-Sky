...
{
public:
    HybridAtmosphereApp(HINSTANCE hInstance);
    ~HybridAtmosphereApp() override;
...
protected:
    ...
    */
    ...
    void LoadCustomPSOs(std::shared_ptr<GDevice> device, std::shared_ptr<GRootSignature> rootSignature,
